...
createMinMaxTuple : List Int -> ( Int, Int )
createMinMaxTuple list =
    Tuple.pair (Maybe.withDefault 0 (List.minimum list)) (Maybe.withDefault 0 (List.maximum list))


calculateRowSum : List (List Int) -> List Int
calculateRowSum list =
    list
        |> List.map createMinMaxTuple
